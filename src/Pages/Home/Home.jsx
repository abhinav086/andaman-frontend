    ...
    <>
      <div className="relative h-screen w-full flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 w-full max-w-6xl px-4 flex flex-col items-center">
          ...
          {/* Search Card */}
          <Card className="w-full max-w-4xl mt-8 md:mt-12 bg-white/95 backdrop-blur-lg p-2.5 rounded-2xl shadow-xl border-none mx-4"> {/* Added mx-4 for horizontal padding on small screens */}
