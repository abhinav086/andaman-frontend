...
const tours = [
  {
    ...
    price: '$500 - $800',
    image: 'https://images.pexels.com/photos/1020016/pexels-photo-1020016.jpeg', // Andaman beach
  },
  {
    id: 2,
    ...
    price: '$700 - $1000',
    image: 'https://images.pexels.com/photos/1666012/pexels-photo-1666012.jpeg', // Himalayan landscape
  },
  {
    id: 3,
    ...
    price: '$400 - $600',
    image: 'https://images.pexels.com/photos/32805562/pexels-photo-32805562.jpeg', // Kerala backwaters
  },
  {
    id: 4,
    ...
    price: '$600 - $900',
    image: 'https://images.pexels.com/photos/1011093/pexels-photo-1011093.jpeg', // Rajasthan palace
  },
];
...
const TourCard = ({ tour }) => (
  <div className="relative w-[360px] h-[550px] rounded-3xl overflow-hidden shadow-lg flex-shrink-0 mx-4">
...
const Carousel = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-700 flex items-center justify-center p-8">
      <div className="bg-white rounded-[40px] shadow-2xl p-8 max-w-7xl w-full">
        {/* Top Filters */}
        <div className="flex flex-wrap gap-4 mb-12">
          {categories.map((category) => (
            <button
              key={category}
              className={`py-2 px-6 rounded-full font-semibold text-sm transition-all duration-200
